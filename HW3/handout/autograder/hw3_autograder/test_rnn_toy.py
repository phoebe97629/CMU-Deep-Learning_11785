...
class RNNToyTest(Test):
    ...
    def test_rnncell_forward(self):
        ...
        for t in range(time_steps):
            ...
            print('input: \n{} \nhidden: \n{}'.format(inp[t].numpy(), hx.detach().numpy()))
    ...
    def test_rnn_classifier(self):
        ...
        seq_len = 3
        input_size = 1
        hidden_size = 4  # hidden_size > 100 will cause precision error
        output_size = 8
